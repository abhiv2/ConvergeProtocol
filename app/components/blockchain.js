...
class Blockchain extends React.Component {
    ...
    getfull(e){
      ...
      StandardToken.balanceOf(["0x7D2262ADb3d47448bC09c79FA40800a8E8636724"]).then(e=>console.log("Balance of address1 :" + e))
     
      StandardToken.balanceOf(["0x58aa3b110Dee7bC14fCD61c6Aade0C7B7FbbbB80"]).then(e=>console.log("Balance of address2 :" + e))
     
      StandardToken.balanceOf(["0x8AcEe242957B1A3c90Af0d3DEA2d8d2c9eb51359"]).then(e=>console.log("Balance of address3 :" + e))
     
      StandardToken.balanceOf(["0x0D1B5571a441175907CdbcffC506C43563e5A65C"]).then(e=>console.log("Balance of address4 :" + e))

      StandardToken.balanceOf(["0xB9fE399612637b23ad45F58cd6272BfB84659609"]).then(e=>console.log("Balance of address4 :" + e))
